...
tocTab[ir++] = new Array ("1", "&Icirc;&aacute;&ugrave;&aring;&aring;", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("1.1", "&Iacute;&agrave;&ccedil;&iacute;&agrave;&divide;&aring;&iacute;&egrave;&aring;", "commonid.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.2", "&Icirc;&iuml;&egrave;&ntilde;&agrave;&iacute;&egrave;&aring; &ograve;&agrave;&aacute;&euml;&egrave;&ouml; &auml;&euml;&yuml; &yacute;&ecirc;&ntilde;&iuml;&icirc;&eth;&ograve;&agrave;", "tabledescribeid.htm", "", "cicon9.gif", "cicon9.gif");
isContent = true,
isIndex = false,
showNumbers = false,
...
function windowErr() {
isDyn = false;
hmtoc.location.href = "exportto1c_content.htm";
window.onerror = oldOnError;
}
function reDisplay(currentNumber,tocChange,noLink,e) {
if (isIndex && (hmtoc.location.href.substring(hmtoc.location.href.lastIndexOf("/")+1,hmtoc.location.href.length) != "exportto1c_kwindex.htm")) { isIndex=false; isContent=true; }
...
hmtoc.location.href = "exportto1c_kwindex.htm";
isIndex = true;
}
hasSelection = false;
if (isContent) {
if (!isDyn) {
if (hmtoc.location.href.substring(hmtoc.location.href.lastIndexOf("/")+1,hmtoc.location.href.length) != "exportto1c_content.htm") hmtoc.location.href = "exportto1c_content.htm";
}
else {
oldOnError = window.onerror;
window.onerror = windowErr;
hmtoc.document.clear();
hmtoc.document.write("<html>\n\r<head></head>\n\r<style type=\"text/css\">\n\r       SPAN.heading1 { font-family: Arial; font-weight: normal; font-size: 10pt; color: #000000; text-decoration: none }\n\r       SPAN.heading2 { font-family: Arial; font-weight: normal; font-size: 9pt; color: #000000; text-decoration: none }\n\r       SPAN.heading3 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #000000; text-decoration: none }\n\r       SPAN.heading4 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #000000; text-decoration: none }\n\r       SPAN.heading5 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #000000; text-decoration: none }\n\r       SPAN.heading6 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #000000; text-decoration: none }\n\r\n\r       SPAN.hilight1 { font-family: Arial; font-weight: normal; font-size: 10pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r       SPAN.hilight2 { font-family: Arial; font-weight: normal; font-size: 9pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r       SPAN.hilight3 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r       SPAN.hilight4 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r       SPAN.hilight5 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r       SPAN.hilight6 { font-family: Arial; font-weight: normal; font-size: 8pt; color: #FFFFFF; background: #002682; text-decoration: none }\n\r</style>\n\r<body bgcolor=\"#FFFFFF\">\n\r<font face=\"Aria\" size=\"4\"><b>&Ntilde;&iuml;&eth;&agrave;&acirc;&ecirc;&agrave;</b></font><br>\n\r<font face=\"Arial\" size=\"2\">\n\r<a href=\"javaScript:parent.reDisplay(\'navIndex\',0,0);\">Keyword Index</a>\n\r</font><br><br><br>\n\r\n\r  <!-- Place holder for the TOC, do not delete the line below -->\n\r  ");
for (i=0; i<tocTab.length; i++) {
if (toDisplay[i]) {
thisNumber = tocTab[i][0];
thisNumArray = thisNumber.split(".");
...
if (isContent && isDyn) {
hmtoc.document.write("\n\r\n\r<hr><font face=\"Arial\" size=\"1\">&copy; 2005 ... &Icirc;&Icirc;&Icirc; &quot;&Iuml;&eth;&icirc;&ocirc;&egrave;&ntilde;&aring;&eth;&acirc;&quot;</font>\n\r</body>\n\r</html>\n\r");
